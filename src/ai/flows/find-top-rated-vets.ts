...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI assistant. Find the top-rated veterinarians near the user's location. Return a list of vets including their name, address, rating, and phone number.\n\nLocation: {{{location}}}`,
});
